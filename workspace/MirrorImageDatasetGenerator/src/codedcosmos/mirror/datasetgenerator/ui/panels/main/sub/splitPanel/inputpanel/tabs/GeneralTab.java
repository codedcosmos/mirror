...
import codedcosmos.mirror.datasetgenerator.ui.panels.main.sub.splitPanel.inputpanel.sub.ThreadSlider;
import codedcosmos.mirror.datasetgenerator.ui.panels.main.sub.splitPanel.inputpanel.sub.folderinput.FolderInput;
...
public class GeneralTab extends JPanel {
	...
	private FolderInput fieldSource = new FolderInput("Source");
	
	private JLabel labelDestination = JUIGenerator.generateLabel("Destination");
	private FolderInput fieldDestination = new FolderInput("Destination");
	...
	public GeneralTab(InputPanel inputPanel) {
	...
	public String getSourceDirectory() {
		return fieldSource.getSelection();
	}
	
	public String getDestinationDirectory() {
		return fieldDestination.getSelection();
	}
}
